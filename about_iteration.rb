...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Inject iterate over the array, calculate and store the value in block argument #1.
    # the block argument #1's default value is inject()'s argument.
  end
  ...
  # I think the first file open method will close file automatically when reaches end.
end
